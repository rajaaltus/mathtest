...
export default function Home() {
  useEffect(() => {
    ...
    $(function () {
      ...
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Multiplication.MultiplicationStrategy");
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Division.DivisionDecimalStrategy");
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Subtraction.SubtractionDecimalStrategy");
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Multiplication.MultiplicationDecimalStrategy");
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.NumberSystem.NumberCountStrategy");
      //Strategies.NumberSystem.NumberCountStrategy

      $("#categorySelect").val(
        "MathEngine.StepGenerator.Strategies.Addition.AdditionFractionStrategy"
      );
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Multiplication.MultiplicationFractionStrategy");
      //$("#categorySelect").val("MathEngine.StepGenerator.Strategies.Division.DivisionFractionStrategy");
      ...
      $("#btnRenderSteps").click(function () {
        ...
        //generateSumFunctionV1(category, renderer, number1, number2, number3);
      ...
      function generateSumFunctionV2(
        category,
        renderer,
        number1,
        number2,
        ...
        $.ajax({
          ...
          success: function (responseRaw) {
            ...
            if (response.resultCode == "Success") {
              ...
              stepsCount = steps.length;
              console.log(
                steps[ind].typeLevel1 + " - " + steps[ind].typeLevel2
              );
    ...
    function maths_animate_move_position_xy(
      textEl,
      animationElx,
      animationEly
    ) {
